...
func init() {
	codegen.Register(codegen.Registration{
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return destination_client_stub{stub: stub, getpidMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver-gke/internal/nanny/managertest/destination", Method: "Getpid"}), recordMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver-gke/internal/nanny/managertest/destination", Method: "Record"}), getAllMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/weaver-gke/internal/nanny/managertest/destination", Method: "GetAll"})}
		},
...
func (s destination_local_stub) Getpid(ctx context.Context) (r0 int, err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "managertest.destination.Getpid", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s destination_local_stub) Record(ctx context.Context, a0 string, a1 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "managertest.destination.Record", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s destination_local_stub) GetAll(ctx context.Context, a0 string) (r0 []string, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "managertest.destination.GetAll", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s source_local_stub) Emit(ctx context.Context, a0 string, a1 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "managertest.source.Emit", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s destination_client_stub) Getpid(ctx context.Context) (r0 int, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "managertest.destination.Getpid", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s destination_client_stub) Record(ctx context.Context, a0 string, a1 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "managertest.destination.Record", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s destination_client_stub) GetAll(ctx context.Context, a0 string) (r0 []string, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "managertest.destination.GetAll", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s source_client_stub) Emit(ctx context.Context, a0 string, a1 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "managertest.source.Emit", trace.WithSpanKind(trace.SpanKindClient))
	}
