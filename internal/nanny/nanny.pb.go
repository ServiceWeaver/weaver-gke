...
type GetListenerAddressRequest struct {
	...
	ReplicaSet string            `protobuf:"bytes,1,opt,name=replica_set,json=replicaSet,proto3" json:"replica_set,omitempty"` // ReplicaSet name (e.g., "main").
	Listener   string            `protobuf:"bytes,2,opt,name=listener,proto3" json:"listener,omitempty"`                       // Listener name.
...
type ActivateComponentRequest struct {
	...
	Component string            `protobuf:"bytes,1,opt,name=component,proto3" json:"component,omitempty"` // Component that needs to be activated.
...
type RegisterReplicaRequest struct {
	...
	ReplicaSet        string            `protobuf:"bytes,1,opt,name=replica_set,json=replicaSet,proto3" json:"replica_set,omitempty"`                      // ReplicaSet name (e.g., "main")
	PodName           string            `protobuf:"bytes,2,opt,name=pod_name,json=podName,proto3" json:"pod_name,omitempty"`                               // Pod name (e.g., main-012345-6789)
	BabysitterAddress string            `protobuf:"bytes,3,opt,name=babysitter_address,json=babysitterAddress,proto3" json:"babysitter_address,omitempty"` // babysitter address, e.g., host:1234
	WeaveletAddress   string            `protobuf:"bytes,4,opt,name=weavelet_address,json=weaveletAddress,proto3" json:"weavelet_address,omitempty"`       // weavelet address, e.g., host:1234
	Config            *config.GKEConfig `protobuf:"bytes,5,opt,name=config,proto3" json:"config,omitempty"`
}
...
func (x *RegisterReplicaRequest) GetReplicaSet() string {
	if x != nil {
		return x.ReplicaSet
	}
	return ""
...
func (x *RegisterReplicaRequest) GetPodName() string {
	if x != nil {
		return x.PodName
	}
	return ""
...
func (x *RegisterReplicaRequest) GetBabysitterAddress() string {
	if x != nil {
...
func (x *RegisterReplicaRequest) GetWeaveletAddress() string {
	if x != nil {
		return x.WeaveletAddress
	}
	return ""
}

func (x *RegisterReplicaRequest) GetConfig() *config.GKEConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
type GetComponentsRequest struct {
	...
	ReplicaSet string            `protobuf:"bytes,1,opt,name=replica_set,json=replicaSet,proto3" json:"replica_set,omitempty"` // ReplicaSet name (e.g., "main")
	Version    string            `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"`                         // Version of the latest fetched component set.
	Config     *config.GKEConfig `protobuf:"bytes,3,opt,name=config,proto3" json:"config,omitempty"`
}
...
type GetComponentsReply struct {
	...
	Version    string   `protobuf:"bytes,1,opt,name=version,proto3" json:"version,omitempty"`       // Version of the current component set.
	Components []string `protobuf:"bytes,2,rep,name=components,proto3" json:"components,omitempty"` // A list of components to run.
}
...
type GetRoutingReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Version string              `protobuf:"bytes,1,opt,name=version,proto3" json:"version,omitempty"`
	Routing *protos.RoutingInfo `protobuf:"bytes,2,opt,name=routing,proto3" json:"routing,omitempty"`
}
...
type GetProfileRequest struct {
	...
	ProfileType protos.ProfileType `protobuf:"varint,3,opt,name=profile_type,json=profileType,proto3,enum=runtime.ProfileType" json:"profile_type,omitempty"`
	// Duration of CPU profiles, in nanoseconds.
	CpuDurationNs int64 `protobuf:"varint,4,opt,name=cpu_duration_ns,json=cpuDurationNs,proto3" json:"cpu_duration_ns,omitempty"`
}
...
func (x *GetProfileRequest) GetProfileType() protos.ProfileType {
	...
	return protos.ProfileType_Unspecified
}
...
type LoadReport struct {
	...
	Load         *protos.LoadReport `protobuf:"bytes,1,opt,name=load,proto3" json:"load,omitempty"`
	ReplicaSet   string             `protobuf:"bytes,2,opt,name=replica_set,json=replicaSet,proto3" json:"replica_set,omitempty"` // ReplicaSet name (e.g., "main")
	PodName      string             `protobuf:"bytes,3,opt,name=pod_name,json=podName,proto3" json:"pod_name,omitempty"`
	WeaveletAddr string             `protobuf:"bytes,4,opt,name=weavelet_addr,json=weaveletAddr,proto3" json:"weavelet_addr,omitempty"`
	Config       *config.GKEConfig  `protobuf:"bytes,5,opt,name=config,proto3" json:"config,omitempty"`
}
...
type VersionStateAtDistributor struct {
	...
	ReplicaSets *ReplicaSetState `protobuf:"bytes,5,opt,name=replica_sets,json=replicaSets,proto3" json:"replica_sets,omitempty"`
}
...
func (x *VersionStateAtDistributor) GetReplicaSets() *ReplicaSetState {
	if x != nil {
...
type GetReplicaSetStateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetReplicaSetStateRequest) Reset() {
	*x = GetReplicaSetStateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetReplicaSetStateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetReplicaSetStateRequest) ProtoMessage() {}

func (x *GetReplicaSetStateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_nanny_nanny_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetReplicaSetStateRequest.ProtoReflect.Descriptor instead.
func (*GetReplicaSetStateRequest) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{19}
}

func (x *GetReplicaSetStateRequest) GetAppName() string {
	if x != nil {
		return x.AppName
	}
	return ""
...
func (x *GetReplicaSetStateRequest) GetVersionId() string {
	if x != nil {
		return x.VersionId
	}
	return ""
...
type ReplicaSetState struct {
	...
	ReplicaSets []*ReplicaSetState_ReplicaSet `protobuf:"bytes,3,rep,name=replica_sets,json=replicaSets,proto3" json:"replica_sets,omitempty"`
...
func (x *ReplicaSetState) GetReplicaSets() []*ReplicaSetState_ReplicaSet {
	if x != nil {
		return x.ReplicaSets
	}
	return nil
...
func (x *ReplicaSetState) GetErrors() []string {
	if x != nil {
		return x.Errors
	}
	return nil
...
func (*TargetFn) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{21}
}
...
func (*FractionSpec) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{22}
}
...
func (x *Schedule) Reset() {
	*x = Schedule{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Schedule) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{23}
}
...
func (x *TrafficAssignment) Reset() {
	*x = TrafficAssignment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TrafficAssignment) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{24}
}
...
func (x *HostTrafficAssignment) Reset() {
	*x = HostTrafficAssignment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HostTrafficAssignment) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{25}
}
...
type TrafficAllocation struct {
	...
	Listener        *Listener `protobuf:"bytes,5,opt,name=listener,proto3" json:"listener,omitempty"`                                        // network listener
}

func (x *TrafficAllocation) Reset() {
	*x = TrafficAllocation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TrafficAllocation) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{26}
}
...
func (x *Listener) Reset() {
	*x = Listener{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Listener) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{27}
}
...
type ReplicaSetState_ReplicaSet struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name       string                            `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Pods       []*ReplicaSetState_ReplicaSet_Pod `protobuf:"bytes,2,rep,name=pods,proto3" json:"pods,omitempty"`
	Components []string                          `protobuf:"bytes,3,rep,name=components,proto3" json:"components,omitempty"` // Active components hosted by ReplicaSet.
	Listeners  []string                          `protobuf:"bytes,4,rep,name=listeners,proto3" json:"listeners,omitempty"`   // Listeners hosted by ReplicaSet.
}

func (x *ReplicaSetState_ReplicaSet) Reset() {
	*x = ReplicaSetState_ReplicaSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReplicaSetState_ReplicaSet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplicaSetState_ReplicaSet) ProtoMessage() {}

func (x *ReplicaSetState_ReplicaSet) ProtoReflect() protoreflect.Message {
	mi := &file_internal_nanny_nanny_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplicaSetState_ReplicaSet.ProtoReflect.Descriptor instead.
func (*ReplicaSetState_ReplicaSet) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{20, 0}
}

func (x *ReplicaSetState_ReplicaSet) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ReplicaSetState_ReplicaSet) GetPods() []*ReplicaSetState_ReplicaSet_Pod {
	if x != nil {
		return x.Pods
	}
	return nil
...
func (x *ReplicaSetState_ReplicaSet) GetComponents() []string {
	if x != nil {
		return x.Components
	}
	return nil
...
func (x *ReplicaSetState_ReplicaSet) GetListeners() []string {
	if x != nil {
		return x.Listeners
	}
	return nil
...
type ReplicaSetState_ReplicaSet_Pod struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ReplicaSetState_ReplicaSet_Pod) Reset() {
	*x = ReplicaSetState_ReplicaSet_Pod{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_nanny_nanny_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReplicaSetState_ReplicaSet_Pod) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplicaSetState_ReplicaSet_Pod) ProtoMessage() {}

func (x *ReplicaSetState_ReplicaSet_Pod) ProtoReflect() protoreflect.Message {
	mi := &file_internal_nanny_nanny_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplicaSetState_ReplicaSet_Pod.ProtoReflect.Descriptor instead.
func (*ReplicaSetState_ReplicaSet_Pod) Descriptor() ([]byte, []int) {
	return file_internal_nanny_nanny_proto_rawDescGZIP(), []int{20, 0, 0}
}

func (x *ReplicaSetState_ReplicaSet_Pod) GetWeaveletAddr() string {
	if x != nil {
		return x.WeaveletAddr
	}
	return ""
...
func (x *ReplicaSetState_ReplicaSet_Pod) GetBabysitterAddr() string {
	if x != nil {
...
func (x *ReplicaSetState_ReplicaSet_Pod) GetHealthStatus() protos.HealthStatus {
	if x != nil {
...
var file_internal_nanny_nanny_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x22, 0x51, 0x0a, 0x18, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44,
	...
	0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x22, 0x7b, 0x0a, 0x18, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x43,
	...
	,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x2e, 0x47, 0x4b, 0x45, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x22, 0x5b, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12,
	0x2e, 0x0a, 0x07, 0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0xae, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x70, 0x70, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65,
	...
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e,
	...
	0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0d, 0x63, 0x70, 0x75, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x73,
	0x22, 0xc1, 0x01, 0x0a, 0x0a, 0x4c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12,
	...
	,
	...
	0x53, 0x65, 0x74, 0x73, 0x22, 0x55, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x53, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x70, 0x70, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_internal_nanny_nanny_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_internal_nanny_nanny_proto_goTypes = []interface{}{
	...
	(*ApplicationDeploymentRequest)(nil),         // 5: nanny.ApplicationDeploymentRequest
	(*ApplicationStopRequest)(nil),               // 6: nanny.ApplicationStopRequest
	(*ApplicationDeleteRequest)(nil),             // 7: nanny.ApplicationDeleteRequest
	(*ActivateComponentRequest)(nil),             // 8: nanny.ActivateComponentRequest
	(*RegisterReplicaRequest)(nil),               // 9: nanny.RegisterReplicaRequest
	(*GetComponentsRequest)(nil),                 // 10: nanny.GetComponentsRequest
	(*GetComponentsReply)(nil),                   // 11: nanny.GetComponentsReply
	(*GetRoutingRequest)(nil),                    // 12: nanny.GetRoutingRequest
	(*GetRoutingReply)(nil),                      // 13: nanny.GetRoutingReply
	(*GetProfileRequest)(nil),                    // 14: nanny.GetProfileRequest
	(*LoadReport)(nil),                           // 15: nanny.LoadReport
	(*ApplicationStateAtDistributorRequest)(nil), // 16: nanny.ApplicationStateAtDistributorRequest
	(*ApplicationStateAtDistributor)(nil),        // 17: nanny.ApplicationStateAtDistributor
	(*VersionStateAtDistributor)(nil),            // 18: nanny.VersionStateAtDistributor
	(*GetReplicaSetStateRequest)(nil),            // 19: nanny.GetReplicaSetStateRequest
	(*ReplicaSetState)(nil),                      // 20: nanny.ReplicaSetState
	(*TargetFn)(nil),                             // 21: nanny.TargetFn
	(*FractionSpec)(nil),                         // 22: nanny.FractionSpec
	(*Schedule)(nil),                             // 23: nanny.Schedule
	(*TrafficAssignment)(nil),                    // 24: nanny.TrafficAssignment
	(*HostTrafficAssignment)(nil),                // 25: nanny.HostTrafficAssignment
	(*TrafficAllocation)(nil),                    // 26: nanny.TrafficAllocation
	(*Listener)(nil),                             // 27: nanny.Listener
	(*ReplicaSetState_ReplicaSet)(nil),           // 28: nanny.ReplicaSetState.ReplicaSet
	(*ReplicaSetState_ReplicaSet_Pod)(nil),       // 29: nanny.ReplicaSetState.ReplicaSet.Pod
	nil,                                          // 30: nanny.TrafficAssignment.HostAssignmentEntry
	(*config.GKEConfig)(nil),                     // 31: config.GKEConfig
	(*protos.RoutingInfo)(nil),                   // 32: runtime.RoutingInfo
	(protos.ProfileType)(0),                      // 33: runtime.ProfileType
	(*protos.LoadReport)(nil),                    // 34: runtime.LoadReport
	(*durationpb.Duration)(nil),                  // 35: google.protobuf.Duration
	(protos.HealthStatus)(0),                     // 36: runtime.HealthStatus
}
var file_internal_nanny_nanny_proto_depIdxs = []int32{
	...
	31, // 1: nanny.VersionDistributionRequest.config:type_name -> config.GKEConfig
	21, // 2: nanny.VersionDistributionRequest.target_fn:type_name -> nanny.TargetFn
	31, // 3: nanny.GetListenerAddressRequest.config:type_name -> config.GKEConfig
	27, // 4: nanny.ExportListenerRequest.listener:type_name -> nanny.Listener
	31, // 5: nanny.ExportListenerRequest.config:type_name -> config.GKEConfig
	31, // 6: nanny.ApplicationDeploymentRequest.versions:type_name -> config.GKEConfig
	31, // 7: nanny.ActivateComponentRequest.config:type_name -> config.GKEConfig
	31, // 8: nanny.RegisterReplicaRequest.config:type_name -> config.GKEConfig
	31, // 9: nanny.GetComponentsRequest.config:type_name -> config.GKEConfig
	31, // 10: nanny.GetRoutingRequest.config:type_name -> config.GKEConfig
	32, // 11: nanny.GetRoutingReply.routing:type_name -> runtime.RoutingInfo
	33, // 12: nanny.GetProfileRequest.profile_type:type_name -> runtime.ProfileType
	34, // 13: nanny.LoadReport.load:type_name -> runtime.LoadReport
	31, // 14: nanny.LoadReport.config:type_name -> config.GKEConfig
	18, // 15: nanny.ApplicationStateAtDistributor.version_state:type_name -> nanny.VersionStateAtDistributor
	20, // 16: nanny.VersionStateAtDistributor.replica_sets:type_name -> nanny.ReplicaSetState
	28, // 17: nanny.ReplicaSetState.replica_sets:type_name -> nanny.ReplicaSetState.ReplicaSet
	22, // 18: nanny.TargetFn.fractions:type_name -> nanny.FractionSpec
	35, // 19: nanny.FractionSpec.duration:type_name -> google.protobuf.Duration
	21, // 20: nanny.Schedule.target_fn:type_name -> nanny.TargetFn
	35, // 21: nanny.Schedule.applied_duration:type_name -> google.protobuf.Duration
	30, // 22: nanny.TrafficAssignment.host_assignment:type_name -> nanny.TrafficAssignment.HostAssignmentEntry
	26, // 23: nanny.HostTrafficAssignment.allocs:type_name -> nanny.TrafficAllocation
	27, // 24: nanny.TrafficAllocation.listener:type_name -> nanny.Listener
	29, // 25: nanny.ReplicaSetState.ReplicaSet.pods:type_name -> nanny.ReplicaSetState.ReplicaSet.Pod
	36, // 26: nanny.ReplicaSetState.ReplicaSet.Pod.health_status:type_name -> runtime.HealthStatus
	25, // 27: nanny.TrafficAssignment.HostAssignmentEntry.value:type_name -> nanny.HostTrafficAssignment
...
func file_internal_nanny_nanny_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_nanny_nanny_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRoutingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internal_nanny_nanny_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetReplicaSetStateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internal_nanny_nanny_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_nanny_nanny_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_nanny_nanny_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_nanny_nanny_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_nanny_nanny_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_nanny_nanny_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicaSetState_ReplicaSet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internal_nanny_nanny_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicaSetState_ReplicaSet_Pod); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
